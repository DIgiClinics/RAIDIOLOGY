...
const About = () => {
  return (
    ...
    <div className="bg-[#0A0A23] py-16 px-4 md:px-8 lg:px-16 flex flex-col items-center justify-center text-center">
      ...
      Pioneering Cancer Grading through Precision Diagnostics.
At Digital Clinics, we are revolutionizing precision cancer therapy through AI-driven digital pathology, combining cancer grading with clinical biomarker identification.

Thus, helping healthcare professionals make timely, personalized treatments possible, improving outcomes & potentially saving lives.
